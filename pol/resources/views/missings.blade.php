                ...
                <div class="row">
                        ...
                        <div class="main--content-inner drop--shadow">
                            ...
                            <div class="content--nav pb--30">
                                <ul class="nav ff--primary fs--14 fw--500 bg-lighter">
                                    ...
                                    <li class="active"><a href="/missings">All Missing People</a></li>
                                    ...
                                    <div class="col-md-4 col-xs-6 col-xxs-12">
                                        ...
                                        <div class="member--item online">
                                            <div class="img img-circle">
                                                <a href="/missings/{{$m->id}}" class="btn-link">
                                                    <img src="{{$m->image}}" alt="">
                                                </a>
                                            </div>
                                            <div class="name">
                                                <h3 class="h6 fs--12">
                                                    <a href="/missings/{{$m->id}}" class="btn-link">{{$m->fn}}&nbsp;{{$m->ln}}</a>
                                                </h3>
                                            </div>
                                            <div class="activity">
                    ...
                    <div class="main--sidebar col-md-4 pb--60" data-trigger="stickyScroll">
                        ...
                        <div class="widget well">
                            <h2 class="h4 fw--700 widget--title">Find A Person</h2>
                        ...
                        <a href="/add-missing">
                            <div class="well" style="background-color: #1B94DF">
                                <h4 style="text-align: center;font-size: 20px; color: white">Add a Missing Person</h4>
                            </div>
                        </a>
